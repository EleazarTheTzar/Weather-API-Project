...
public class weatherservice {
	...
	public static weatherdata obj = new weatherdata();
    // Open Weather Map API key
    private static final String key = "77a2d6fadad407acd5177d5ced44a274";

    // API endpoint for getting weather data
    private static final String endpoint = "http://api.openweathermap.org/data/2.5/weather?q=Dallas&APPID=77a2d6fadad407acd5177d5ced44a274";
    ...
    private static weatherdata parseJSON(String json) {
        // Parse entire JSON string and convert to objet
