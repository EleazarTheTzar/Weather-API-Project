...
public class weatherbot extends PircBot {
    ...
    // IRC channel to join
    static final String channel = "#MemeTeam";

    // Name of bot
    static final String name = "SlavicWeatherBot";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            bot.sendMessage(channel, "Cyka Blyat! It is me, slavic weather bot created by Eleazar Espinoza.");
        }
    }
